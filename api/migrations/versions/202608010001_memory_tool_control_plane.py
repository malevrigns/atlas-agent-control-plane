...
def upgrade() -> None:
    ...
    op.add_column("agent_memories", sa.Column("value", JSONB, nullable=False, server_default=sa.text("'{}'::jsonb")))
    ...
    op.add_column("agent_memories", sa.Column("provenance", JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")))
    ...
    op.add_column("agent_memories", sa.Column("verification", JSONB, nullable=False, server_default=sa.text("'{}'::jsonb")))
    op.create_foreign_key("fk_agent_memories_supersedes", "agent_memories", "agent_memories", ["supersedes"], ["id"], ondelete="SET NULL")
    ...
    op.create_table(
        ...
        sa.Column("acceptance_criteria", JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
        sa.Column("status", sa.String(32), nullable=False, server_default="pending"),
        sa.Column("progress", JSONB, nullable=False, server_default=sa.text("'{\"done\":[],\"doing\":[],\"blocked\":[]}'::jsonb")),
        sa.Column("known_failures", JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
        sa.Column("open_questions", JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
        sa.Column("next_actions", JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
        sa.Column("must_preserve", JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
    ...
    op.create_table(
        ...
        sa.Column("verification", JSONB, nullable=False, server_default=sa.text("'{}'::jsonb")),
    ...
    op.create_foreign_key("fk_agent_memories_task", "agent_memories", "agent_tasks", ["task_id"], ["id"], ondelete="SET NULL")


def downgrade() -> None:
    op.drop_constraint("fk_agent_memories_task", "agent_memories", type_="foreignkey")
    for table in [
        "tool_invocations",
        "retrieval_traces",
        "skill_executions",
    ...
    op.drop_constraint("fk_agent_memories_supersedes", "agent_memories", type_="foreignkey")
    for column in [
