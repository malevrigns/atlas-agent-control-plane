...
def _build_react_service(uow: UnitOfWork, model: LLMService) -> ReActAgentService:
    ...
    file_sync = SessionFileSyncService(
        uow,
    ...
    def from_uow(
        ...
        *,
        ...
        return cls(
            ...
            or PlannerService(uow, llm_service=model),
            react_service=_build_react_service(uow, model),
            llm_service=model,
        )
