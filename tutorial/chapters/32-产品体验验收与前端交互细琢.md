...
​        旧版教程把“成熟 Agent 产品体验点验”与“前端产品化交互与视觉细琢”拆成了相邻两章。两者实际上属于同一条能力链：前者把基础结构立住，后者让它进入可用状态。本章将它们合并为前后两个阶段，保留原来的实现、验证与工程判断，同时减少能力尚未闭环时的章节跳转。

## 32.2 第一阶段：成熟 Agent 产品体验点验

### 32.2.1 本阶段目标

​        学完本阶段后，你将能够：

​        从实现顺序看，第一，理解为什么最终阶段要做产品体验验收；第二，新增产品体验验收清单接口；第三，把自然对话、计划执行、工具预览、记忆、多 Agent、Harness、浏览器和 VNC 放到同一张验收表里；第四，区分“已有自动化证据”和“必须人工观察”的验收项；第五，在设置页查看最终验收清单；第六，使用 Docker Compose 完成端到端验收。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
​        放到工程语境里看，第一，验收项总数；第二，已有自动化证据数量；第三，需要人工确认数量；第四，每条验收项的证据、验证步骤和相关接口。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
​        展开来看，第一，接口都能调通，但页面流程不顺；第二，单个工具能用，但没有进入统一时间线；第三，Harness 能跑，但没有和产品体验验收关联；第四，记忆接口存在，但没有确认是否真的进入上下文；第五，浏览器截图能返回，但 VNC 观察没有被纳入最终检查；第六，失败、停止、重试接口都在，但没有形成验收路径。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
​        本阶段新增 `ProductAcceptanceService`。
...
#### 32.2.5.3 实现 ProductAcceptanceService
...
​        具体来说，第一，当前要验收什么；第二，为什么认为这个能力已经具备；第三，具体怎么验证；第四，出问题时优先看哪些接口。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
​        换句话说，第一，很多体验无法只靠接口自动证明；第二，最终验收需要同时覆盖后端、前端、沙箱、工具、记忆和部署；第三，验收清单要能被测试，不能只是文档里的文字。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

​        项目亮点：

​        从实现顺序看，第一，最终体验验收进入 API 和设置页；第二，验收项覆盖对话、计划、工具、记忆、多 Agent、Harness、浏览器和部署；第三，每项都提供证据、验证步骤和相关接口；第四，为本章第二阶段最终交付和二次开发指南打基础。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

### 32.2.8 面试考点

​        放到工程语境里看，第一，为什么最终验收不能只看单个接口？；第二，Agent 产品体验验收应该覆盖哪些链路？；第三，哪些能力可以自动测试，哪些必须人工观察？；第四，为什么 Harness 不能完全替代产品体验验收？；第五，为什么工具调用需要进入统一事件流和统一预览？。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
#### 32.2.9.4 Docker 构建和启动

​        本阶段改了 API 和 UI，建议重新构建镜像：
...
​        展开来看，第一，点击左侧“设置”；第二，确认出现“产品体验验收”面板；第三，确认面板顶部显示验收项总数、已有证据和人工确认数量；第四，查看每条验收项是否包含证据、验证步骤和相关接口；第五，回到“工作台”，发送一个真实任务；第六，确认对话区出现用户消息、计划、步骤、工具调用和最终结果；第七，点击工具调用卡片，确认右侧预览或弹层可以看到详情。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

### 32.2.10 阶段小结

​        本阶段完成了成熟 Agent 产品体验验收入口：

​        具体来说，第一，新增产品验收领域实体；第二，新增 `ProductAcceptanceService`；第三，新增 `/api/acceptance/checks` 接口；第四，新增本阶段后端测试；第五，前端设置页新增“产品体验验收”面板；第六，验收清单覆盖对话、计划、工具、记忆、多 Agent、Harness、浏览器、VNC、失败恢复和 Compose 启动。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

​        从这一阶段开始，项目具备了一张最终体验验收表。后续做二次开发时，可以先看这张表，确认改动有没有破坏核心 Agent 产品链路。

## 32.3 第二阶段：前端产品化交互与视觉细琢

### 32.3.1 本阶段目标

​        学完本阶段后，你将能够：

​        换句话说，第一，理解为什么最终阶段要集中打磨前端体验；第二，把主工作台从“功能可用”升级为“任务执行工作台”；第三，优化对话区、任务时间线、步骤节点、工具调用卡片和最终结果展示；第四，优化底部任务输入台，让用户只需要自然发送任务；第五，优化右侧工具预览区，让它更像 Agent 的远程电脑；第六，移除主工作台的演示感，保留设置页中的配置、诊断、安全和验收面板；第七，使用类型检查、构建和浏览器页面验证检查前端改动。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
​        放到工程语境里看，第一，主区域只服务 AI 对话和任务过程；第二，工具详情按需出现在右侧；第三，设置、诊断、安全、验收继续留在设置页；第四，输入区只保留任务分配和附件入口。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

### 32.3.4 本阶段技术方案

​        本阶段不大改后端，不新增数据库表，也不重写 Agent Runner。
...
​        展开来看，第一，第一个画网格；第二，第二个画顶部蓝色光感和底部暗色过渡。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
​        具体来说，第一，上下文；第二，清未读；第三，停止。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

​        但按钮改成圆角胶囊，视觉上更轻。

#### 32.3.5.6 优化 ConversationTimeline
...
​        换句话说，第一，左侧圆点表示状态；第二，标题表示任务拆解；第三，正文表示当前动作或结果；第四，工具胶囊表示调用过程；第五，点击步骤打开详情弹窗；第六，点击工具打开右侧工作区。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
​        本阶段把输入区上方的“自动规划、工具调用、结果汇总”等标签去掉。原因是这些能力应该在任务执行流里自然出现，而不是作为静态说明占住输入区。输入区只保留两件事：

​        从实现顺序看，第一，用户要交给 Agent 的任务；第二，发送和附件入口。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
##### 32.3.5.9.1 为什么叫“AtlasAgent 的电脑”
...
​        放到工程语境里看，第一，文件；第二，Shell 输出；第三，浏览器截图；第四，搜索结果；第五，MCP 返回；第六，A2A 返回；第七，多 Agent 协作结果。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

​        这个心智模型比“工具详情面板”更接近真实 Agent 产品体验。

### 32.3.6 关键理解

​        本阶段最重要的是理解“产品化前端不是换颜色”。
...
​        展开来看，第一，Harness；第二，诊断；第三，安全；第四，验收；第五，模块配置。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

​        工作台只保留：

​        具体来说，第一，对话；第二，执行过程；第三，工具预览；第四，上下文和文件按需抽屉。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

​        第三个重点是保持数据流不变。

​        本阶段主要改组件表现，不改：

​        换句话说，第一，Zustand store；第二，SSE 数据流；第三，后端事件结构；第四，Agent Runner。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
​        从实现顺序看，第一，前端视觉升级不能破坏已有交互；第二，暗色界面容易出现文字层级混乱；第三，工具预览、文件预览、上下文预览都要共用右侧空间；第四，移动端不能因为固定宽度出现文字溢出。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

​        项目亮点：

​        放到工程语境里看，第一，主工作台从功能集合升级为任务执行空间；第二，输入框表达“发送任务后自动规划和执行”；第三，计划、步骤和工具调用形成更连贯的任务流；第四，右侧预览更像 Agent 的远程工作区；第五，设置页继续承担配置、诊断、安全和验收职责。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

### 32.3.8 面试考点

​        展开来看，第一，为什么 Agent 产品主界面应该围绕任务流设计？；第二，为什么工具预览适合按需打开，而不是一直平铺？；第三，为什么本阶段只改表现层，不改状态管理和后端数据结构？；第四，如何避免前端功能越加越像后台管理系统？；第五，暗色工作台中如何处理文字层级和状态反馈？。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。
...
#### 32.3.9.3 Docker 构建和启动

​        本阶段改了 UI，建议重新构建 UI 镜像：
...
​        具体来说，第一，浏览器页面本身不出现整页滚动条；第二，左侧会话列表较多时，只在会话列表内部滚动；第三，中间对话内容较多时，只在对话执行流内部滚动，底部输入框保持固定；第四，主工作台是暗色网格背景和居中的任务执行流，不再像功能卡片集合；第五，工作台页不再显示顶部大标题、API 状态和数据库状态；第六，当前会话标题只在对话执行区顶部轻量展示；第七，空状态提示“直接描述任务，Agent 会开始规划和执行”；第八，输入框提示“分配一个任务或提问任何问题”；第九，发送任务后，时间线展示用户消息、Agent 计划、思维链式步骤节点和工具调用入口；第十，点击任意步骤节点，页面弹出步骤详情；第十一，点击工具调用后，右侧出现“AtlasAgent 的电脑”预览区；第十二，点击“上下文”后，右侧出现上下文抽屉；第十三，切换到“设置”页，Harness、产品体验验收、系统诊断、安全边界仍然可用。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

### 32.3.10 阶段小结

​        本阶段完成了前端产品化交互与视觉打磨的第一轮：

​        换句话说，第一，优化主页面外层和标题区；第二，优化 ChatWorkspace 工作台容器；第三，优化会话控制栏；第四，优化对话空状态、计划块、步骤节点和最终结果卡片；第五，优化底部任务输入台；第六，优化右侧工具预览工作区；第七，更新 UI README 和课程大纲。这些点放在一起看，构成了本阶段叙述中需要连续理解的一条线索，而不是彼此孤立的项目清单。

​        从这一阶段开始，项目不只是“功能都能用”，而是更像一个真正围绕 AI 任务执行设计的 Agent 工作台。

​        但本阶段不是最终 UI 封版。后续还会继续拆章节处理组件体系、流式动效、工具工作区、响应式和可访问性，避免把所有前端优化都塞进一章里。
