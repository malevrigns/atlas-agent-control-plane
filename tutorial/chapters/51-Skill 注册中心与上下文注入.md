...
到这里，后端的四类注入物（Tool / Memory / RAG / Skill）都有了各自的治理面。下一章我们把这些能力搬到桌面客户端上——从一个只有时间线的单文件界面，重构成能真正管理它们的工作台。

---

[← 第五十章. RAG 检索增强生成与知识库](50-RAG%20检索增强生成与知识库.md) · [返回目录](../README.md) · [第五十二章. 桌面客户端重构与管理工作台 →](52-桌面客户端重构与管理工作台.md)
