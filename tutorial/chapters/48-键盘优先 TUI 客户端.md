...
在 SSH、低带宽、远程服务器和键盘工作流中，Web 和 Electron 都不是最短路径。本章使用 Textual 提供一个独立 Python TUI，它与其他客户端复用同一套 API，不把业务逻辑复制到终端。
...
[← 第四十七章. Electron 多主题桌面客户端](47-Electron%20多主题桌面客户端.md) · [返回目录](../README.md) · [第四十九章. 迁移、测试与交付验收 →](49-迁移、测试与交付验收.md)
